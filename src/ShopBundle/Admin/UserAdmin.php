    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add('roles', 'doctrine_orm_string', array(), 'choice', array(
                'choices'  => array('ROLE_MODERATOR'=>'Client', 'ROLE_ADMIN'=>'Admin'),
                ))
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('roles', 'choice', array(
                'choices'  => array('ROLE_USER'=>'User', 'ROLE_MODERATOR'=>'Client', 'ROLE_SUPER_ADMIN'=>'Admin'),
                'multiple' => true
            ))
...
//        $rolesChoices = $this->flattenRoles($roles);
        ...
        $formMapper
            ...
            ->add('username')
            ->add('roles', 'choice', array(
                'choices'  => array('ROLE_MODERATOR'=>'User', 'ROLE_ADMIN'=>'Admin'),
                'multiple' => true
            ))
